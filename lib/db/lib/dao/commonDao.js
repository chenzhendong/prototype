...
function CommonDao (mongoose, schemaName){
	var schema = mongoose.ref.Schema(schemas[schemaName], { collection: schemaName, 'autoIndex': false });
    schema.plugin(uniqueValidator);
    this.model = mongoose.connection.model(schemaName, schema);
}
